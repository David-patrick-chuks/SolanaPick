 ...
 */
export async function generateSerializedTransaction(options: GenerateTransactionOptions): Promise<string> {
  ...
  const payerKey = typeof payerPublicKey === 'string' ? new PublicKey(payerPublicKey) : payerPublicKey;
